        ...
        <div class="content">
          <div class="page-inner">
            <div class="page-header">
              <h4 class="page-title">Details Reparation #<%= reparation.getIdReparation() %></h4>
              <ul class="breadcrumbs">
                ...
                <li class="nav-item">
                  <a href="/ReparationOrdi/reparations">Reparation</a>
                </li>
                <li class="separator">
                  <i class="icon-arrow-right"></i>
                </li>
                ...
                <div class="col-md-12">
                  ...
                  <div class="card">
                    <div class="card-header">
                      <h4 class="card-title">Informations de la Reparation</h4>
                    </div>
                    <div class="card-body">
                      <div class="table-responsive">
                        <table class="table">
                          ...
                          <tr>
                            <th>Ordinateur</th>
                            <td><%= reparation.getOrdinateur().getModele().getNom() + " - " + reparation.getOrdinateur().getIdSerie() %></td>
                          </tr>
                          <tr>
                  ...
                  <div class="card">
                    <div class="card-header">
                      <h4 class="card-title">Composants Utilises</h4>
                    </div>
                    <div class="card-body">
                      <div class="table-responsive">
                        <table class="table">
                          ...
                          <tbody>
                            <% for(Composant composant : reparation.getComposants()) { %>
                            <tr>
