    ...
    <div class="wrapper">
        ...
        <div class="content">
            ...
            <div class="page-header">
                <h4 class="page-title">Type Composant List</h4>
            ...
            <div class="row">
                ...
                <div class="card">
                    ...
                    <h4 class="card-title">Types Composants existants</h4>
                    </div>
                    <div class="card-body">
                    <div class="table-responsive">
                        ...
                        <tbody>
                            ...
                            <tr>
                            <td><%= typecomposant.getIdTypeComposant() %></td>
                            <td><%= typecomposant.getNomType() %></td>
                            </tr>
                            <% } %>
                        </tbody>
                        </table>
