            ...
            <div class="page-category">
                ...
                <div class="col-md-6">
                    ...
                    <div class="card-header">
                        <h4 class="card-title">Nouvel Ordinateur</h4>
                    </div>
                    <div class="card-body">
                        <form action="/ReparationOrdi/ordinateurform" method="post">
                        <div class="form-group">
                            <label for="id_serie">Id Serie</label>
                            <input type="text" class="form-control" id="id_serie" name="id_serie" placeholder="Entrer l'id serie" required>
                        </div>
                        <div class="form-group">
                            <label for="modele">Modele</label>
                            <select class="form-select form-control" id="modele" name="id_modele">
                            <% for(Modele modele : modeles) { %>
                                <option value="<%= modele.getIdModele() %>"><%= modele.getNom() %></option>
                            <% } %>
                            </select>
                        </div>
                        <div class="form-group">
                            <label for="client">Client</label>
                            <select class="form-select form-control" id="client" name="id_client">
