...
<%    
    List<TypeComposant> composants=(List<TypeComposant>)request.getAttribute("typeComposants");
%>
<head>
    <meta charset="utf-8">
    <title>Atelier</title>
                ...
                <div class="row g-4">
                    <div class="col-sm-12 col-xl-6">
                        <div class="bg-secondary rounded h-100 p-4">
                            <h6 class="mb-4">Insertion d'un nouveau composant</h6>
                            <form action="/ReparationOrdi/composantform" method="post">
                                <div class="mb-3">
                                    <label for="nom" class="form-label">Nom du composant</label>
                                    <input type="text" class="form-control" id="nom"
                                        aria-describedby="emailHelp" name="nom">

                                    <label for="id_composant">Type du composant:</label>
                                    <select id="id_composant" name="id_composant" required>
                                        <% for (TypeComposant comp : composants) { %>
                                            <option value="<%= comp.getIdTypeComposant() %>"><%= comp.getNomType() %></option>
                                        <% } %>
                                    </select><br>

                                    <label for="prix" class="form-label">Prix du composant</label>
