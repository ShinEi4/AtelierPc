        ...
        <div class="content">
          <div class="page-inner">
            <div class="page-header">
              <h4 class="page-title">Categorie Modele List</h4>
                ...
                <div class="col-md-12">
                  <div class="card">
                    <div class="card-header">
                      <h4 class="card-title">Categorie Modele enregistres</h4>
                    </div>
                    <div class="card-body">
                      <div class="table-responsive">
                        <table class="table">
                          ...
                          <tbody>
                            ...
                            <tr>
                              <td><%= categorie.getIdCategorieModele() %></td>
                              <td><%= categorie.getNomType() %></td>
                            </tr>
                            <% } %>
                          </tbody>
                        </table>
