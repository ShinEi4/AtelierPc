...
<%
    double currentPourcentage = (Double)request.getAttribute("currentPourcentage");
        ...
        <div class="content">
          <div class="page-inner">
            <div class="page-header">
              <h4 class="page-title">Configuration Commission</h4>
            ...
            <div class="page-category">
              <div class="card">
                <div class="card-header">
                  <h4 class="card-title">Definir le pourcentage de commission</h4>
                </div>
                <div class="card-body">
                  <% if (success != null) { %>
                  ...
                  <div class="alert alert-info" role="alert">
                    Pourcentage actuel : <%= currentPourcentage %>%
                  </div>

                  <form action="/ReparationOrdi/commission" method="post">
                    <div class="form-group">
                      <label for="pourcentage">Nouveau pourcentage de commission (%)</label>
                      <input type="number" step="0.01" min="0" max="100" class="form-control" 
                             id="pourcentage" name="pourcentage" required>
                    </div>
