        ...
        <div class="content">
          <div class="page-inner">
            <div class="page-header">
              <h4 class="page-title">Categorie Form</h4>
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="card">
                    ...
                    <div class="card-body">
                      <form action="/ReparationOrdi/categorieform" method="post">
                        <div class="form-group">
                          <label for="nom">Nom de la categorie</label>
                          <input type="text" class="form-control" id="nom" name="nom" placeholder="Entrer le nom de la categorie" required>
                        </div>
