        ...
        <div class="content">
          <div class="page-inner">
            <div class="page-header">
              <h4 class="page-title">Marque Form</h4>
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="card">
                    ...
                    <div class="card-body">
                      <form action="/ReparationOrdi/marqueform" method="post">
                        <div class="form-group">
                          <label for="nom">Nom de la marque</label>
                          <input type="text" class="form-control" id="nom" name="nom" placeholder="Entrer le nom de la marque" required>
                        </div>
