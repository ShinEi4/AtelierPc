        ...
        <div class="content">
          <div class="page-inner">
            <div class="page-header">
              <h4 class="page-title">Type Composant Form</h4>
                ...
                <div class="col-md-6">
                  <div class="card">
                    <div class="card-header">
                      <h4 class="card-title">Ajout Type Composant</h4>
                    </div>
                    <div class="card-body">
                      <form action="/ReparationOrdi/typecomposantform" method="post">
                        <div class="form-group">
                          <label for="nom">Nom du type composant</label>
                          <input type="text" class="form-control" id="nom" name="nomType" placeholder="Entrer le nom du type composant" required>
                        </div>
