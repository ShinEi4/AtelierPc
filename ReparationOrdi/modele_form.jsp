...
<%
    ...
    List<CategorieModele> categoriesmodeles=(List<CategorieModele>)request.getAttribute("categoriesmodeles");
%>
  <head>
    <meta charset="UTF-8" />
    ...
    <div class="wrapper">
        ...
        <div class="content">
            ...
            <div class="page-header">
                <h4 class="page-title">Modele Form</h4>
            ...
            <div class="page-category">
                ...
                <div class="col-md-6">
                    ...
                    <div class="card-header">
                        <h4 class="card-title">Nouveau Modele</h4>
                    </div>
                    <div class="card-body">
                        <form action="/ReparationOrdi/modeleform" method="post">
                        <div class="form-group">
                            <label for="nom">Nom du modele</label>
                            <input type="text" class="form-control" id="nom" name="nom" placeholder="Entrer le nom du modele" required>
                        </div>
                        <div class="form-group">
                            <label for="marque">Marque</label>
                            <select class="form-select form-control" id="marque" name="marque">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-select form-control" id="categorie" name="categorie">
                            <% for(CategorieModele categorie : categoriesmodeles) { %>
                                <option value="<%= categorie.getIdCategorieModele() %>"><%= categorie.getNomType() %></option>
                            <% } %>
                            </select>
                        </div>
