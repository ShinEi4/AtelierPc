...
<%
    List<Technicien> commissionsBySexe = (List<Technicien>)request.getAttribute("commissionsBySexe");
%>
  <head>
    <meta charset="UTF-8" />
            ...
            <ul class="nav nav-secondary">
              ...
              <li class="nav-item">
                ...
                <div class="collapse" id="etats">
                  <ul class="nav nav-collapse">
                    <li>
                      <a href="/ReparationOrdi/commission-par-sexe">
            ...
            <div class="page-category">
              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="card">
                    <div class="card-body">
                        <form action="/ReparationOrdi/commission-par-sexe" method="get" class="form-inline">
                            <div class="form-group mx-sm-3 mb-2">
                                ...
                                <label for="dateFin" class="mr-2 ml-2">Au : </label>
                  ...
                  <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">
                            <% if (request.getAttribute("dateDebut") != null && request.getAttribute("dateFin") != null) { %>
                                Commissions par sexe du ${dateDebut} au ${dateFin}
                            <% } else if (request.getAttribute("dateDebut") != null) { %>
                                Commissions par sexe à partir du ${dateDebut}
                            <% } else if (request.getAttribute("dateFin") != null) { %>
                                Commissions par sexe jusqu'au ${dateFin}
                            <% } else { %>
                    ...
                    <div class="card-body">
                      <div class="table-responsive">
                        <table class="table table-bordered">
                          <thead class="bg-primary text-white">
                            <tr>
                              <th class="text-center">ID Sexe</th>
                          ...
                          <tbody>
                            ...
                            for(Technicien tech : commissionsBySexe) { 
                                totalGeneral += tech.getTotalCommission();
                            %>
                            <tr>
                              <td class="text-center"><%= tech.getSexe().getIdSexe() %></td>
                              <td class="text-center"><%= tech.getSexe().getNom() %></td>
                              <td class="text-right">
                                <%= String.format("%,.2f", tech.getTotalCommission()) %> Ar
                              </td>
                            </tr>
                            <% } %>
                            <tr class="bg-light font-weight-bold">
                              ...
                              <td class="text-right">
                                <%= String.format("%,.2f", totalGeneral) %> Ar
                              </td>
                            </tr>
                          </tbody>
                        </table>
                      ...
                      <div class="mt-4">
                        <h5>Repartition des commissions</h5>
                        <div class="table-responsive">
                          <table class="table table-bordered">
                            ...
                            <tbody>
                              <% for(Technicien tech : commissionsBySexe) { 
                                  double pourcentage = totalGeneral > 0 ? 
                                      (tech.getTotalCommission() / totalGeneral) * 100 : 0;
                              %>
                              <tr>
                                <td class="text-center"><%= tech.getSexe().getNom() %></td>
                                <td class="text-right">
