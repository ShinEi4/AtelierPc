        ...
        <div class="content">
          <div class="page-inner">
            <div class="page-header">
              <h4 class="page-title">Technicien Form</h4>
              <ul class="breadcrumbs">
                ...
                <li class="nav-item">
                  <a href="/ReparationOrdi/technicienform">Technicien</a>
                </li>
                <li class="separator">
                    <i class="icon-arrow-right"></i>
                </li>
                ...
                <div class="col-md-6">
                  <div class="card">
                    <div class="card-header">
                      <h4 class="card-title">Nouveau Technicien</h4>
                    </div>
                    <div class="card-body">
                      <form action="/ReparationOrdi/technicienform" method="post">
